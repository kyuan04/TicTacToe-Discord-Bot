...
function isGameOver() {
    for (let i = 0; i < 3; i++) {
        if (tictactoe_state[i][0] == tictactoe_state[i][1] && tictactoe_state[i][2] == tictactoe_state[i][1] && tictactoe_state[i][2] != EMPTY) {
            return true;
        }
    ...
    if (tictactoe_state[1][1] != EMPTY) {
        if ((tictactoe_state[0][0] == tictactoe_state[1][1] && tictactoe_state[1][1] == tictactoe_state[2][2]) || (tictactoe_state[2][0] == tictactoe_state[1][1] && tictactoe_state[0][2] == tictactoe_state[1][1])) {
            return true;
        }
    }
    return false;
